...
# Mapping documented in cognition_mapping.md.
# Output: cognition_31_fixed.csv (ID, wave, components, cog_cap_31).
# ============================================================
...
write_csv(cognition, file.path(out_root, "cognition_31_fixed.csv"))
